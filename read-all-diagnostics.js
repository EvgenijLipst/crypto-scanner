...
function readAllDiagnostics() {
  ...
  console.log('⏱️  Signal Bot: диагностика каждые 5 минут');
  console.log('⏱️  Tradebot: диагностика каждую минуту');
  console.log('⏱️  Telegram: логирование в реальном времени\n');
